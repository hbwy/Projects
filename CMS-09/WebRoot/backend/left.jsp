...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">文章管理</a>
      <ul>
        <li><a href="ArticleServlet?m=list" target="rightFrame">查询文章</a></li>
        <li><a href="ArticleServlet?m=addInput" target="rightFrame">添加文章</a></li>
        <li><a href="../site/MessageServlet?m=articlelist" target="rightFrame">留言管理</a></li>
      </ul>
    </li>
    <li> <a class="head">频道管理</a>
      <ul>
        <li><a href="ChannelServlet?m=list" target="rightFrame">查询频道</a></li>
    ...
    <li> <a class="head">会员管理</a>
      <ul>
        <li><a href="MemberAdminServlet?m=query" target="rightFrame">会员管理</a></li>
      </ul>
    </li>
