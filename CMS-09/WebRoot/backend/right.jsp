<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,cms.model.*"
    pageEncoding="UTF-8"%>
<%
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="#" title="点击查看和编辑文章"><%--=a.getTitle() --%></a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getSource() --%></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getClickScore() --%></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getMsgCount() --%></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getCreateTime() --%></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getUpdateTime() --%></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%--=a.getPublishTime() --%></div></td>
